  ...
  return (
    <div className="glass pointer-events-auto flex animate-fade-in items-center gap-1 rounded-2xl p-1.5">
      ...
      <QuickToggle
        ...
        iconOn={<Eye className="size-4.5" />}
        iconOff={<EyeOff className="size-4.5" />}
        accent="beacon"
      />
      <QuickToggle
        ...
        iconOn={<Volume2 className="size-4.5" />}
        iconOff={<VolumeX className="size-4.5" />}
        accent="warm"
      />
      <QuickToggle
        on={theme === "light"}
        onClick={toggleTheme}
        label="Сменить тему"
        iconOn={<Sun className="size-4.5" />}
        iconOff={<Moon className="size-4.5" />}
        accent="warm"
      />
    </div>
  )
